...
java -Xmx500m -jar Trimmomatic-0.39/trimmomatic-0.39.jar PE -summary test.summary SRR10178655_1.fastq.gz SRR10178655_2.fastq.gz test_1_passed.fastq test_1_failed.fastq test_2_passed.fastq test_2_failed.fastq MINLEN:100 ILLUMINACLIP:./adapters.fa:2:30:10:2:keepBothReads

bwa mem -t 4 -R '@RG\tID:SRR10178655\tID:SRR10178655\tLB:SRR10178655\tPL:ILLUMINA' ./Scerevisiae.fasta SRR10178655_1.fastq.gz SRR10178655_2.fastq.gz | samtools view -u - | samtools sort -m 1G -o SRR10178655.bam -

samtools index SRR10178655.bam

./gatk-4.1.4.0/gatk MarkDuplicates --java-options '-Xmx1G'  --VALIDATION_STRINGENCY SILENT -I SRR10178655.bam -O SRR10178655.mdup.bam -M SRR10178655.mdup.metrics -MAX_FILE_HANDLES 2000

samtools stats -@4 --ref-seq Scerevisiae.fasta SRR10178655.mdup.bam >SRR10178655.stats
